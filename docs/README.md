...
After bootstrap, your project's `.claude/` will contain:
...
│   └── [project-specific].md  # Generated by bootstrap (architecture, boundaries)
├── commands/
│   ├── deep-audit.md
│   ├── audit-fix.md
│   ├── refactor.md
...
No docs/, no decisions/, no bootstrap.md. Clean.
...
| Path | Purpose |
|------|---------|
| `.claude/rules/coding-standards.md` | Universal file/function size limits |
| `.claude/rules/testing.md` | Universal TDD + Vitest rules |
